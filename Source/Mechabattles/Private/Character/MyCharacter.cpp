...
{
	BodyComponent -> SetWorldLocationAndRotation(GetMesh()->GetComponentLocation(),GetMesh()->GetComponentRotation());
...
void AMyCharacter::BeginPlay()
{
	...
	AttachBodyParts(Chest);
	AttachBodyParts(Hands);
	AttachBodyParts(Legs);
	...
	Eyes->AttachToComponent(GetMesh(),AttachmentRules, FName("headSocket"));
	Eyebrow -> AttachToComponent(GetMesh(),AttachmentRules, FName("headSocket"));
...
void AMyCharacter::SetBodyPartMeshes()
{
	GetMesh()->SetSkeletalMesh(BodyParts.Head);
	Chest->SetSkeletalMesh(BodyParts.Chest);
	Legs->SetSkeletalMesh(BodyParts.Legs);
	Hands->SetSkeletalMesh(BodyParts.Hands);
	Beard->SetStaticMesh(BodyParts.Beard);
	Hair->SetStaticMesh(BodyParts.Hair);
}
