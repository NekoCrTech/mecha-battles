...
void AGrid_Bugged::OnConstruction(const FTransform& Transform)
{
...
void AGrid_Bugged::SpawnGrid(const FVector CenterLocation, const FVector TileSize, const FIntPoint TileCount, bool bUseEnvironment)
{
...
void AGrid_Bugged::CalculateCenterAndBottomLeft(FVector& Center, FVector& BottomLeft)
{
...
FVector AGrid_Bugged::GetTileLocationFromGridIndex(FIntPoint GridIndex)
{
...
bool AGrid_Bugged::TraceForGround(FVector& InLocation, FVector& HitLocation, ETileType& TileType)
{
...
void AGrid_Bugged::GetCursorLocationOnGrid()
{
}

void AGrid_Bugged::SpawnInstance(FIntPoint Index, bool bUseEnvironment)
{
...
void AGrid_Bugged::AddGridTile(FTileData Data)
{
	GridTiles.Add(Data.Index, Data);
	GridVisual->UpdateTileVisual(Data);
}

int32 AGrid_Bugged::AdjustForOdd(int32 GridCount)
{
	return GridCount % 2 != 0 ? 1 : 0;
}

// Called every frame
void AGrid_Bugged::Tick(float DeltaTime)
{
